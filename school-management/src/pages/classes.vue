           ...
           <template v-slot:toolbar>
            ...
            <v-hover v-slot:default="{ hover }">
              <v-btn
                ...
                class="mb-2 mr-2"
                :to="{ name:'ClassViewPage', params: { classId: selectedItem?selectedItem.id: 'none' } }"
                tile
              >View</v-btn>
            </v-hover>
            ...
            <v-hover v-slot:default="{ hover }">
              <v-btn
                ...
                :color="hover ? 'primary' : 'primary'"
                class="mb-2 mr-2"
                :to="{ name:'ClassEditPage', params: { classId: selectedItem?selectedItem.id: 'none' } }"
                tile
              >Edit</v-btn>
            </v-hover>
            <v-hover v-slot:default="{ hover }">
...
export default {
  ...
  methods: {
    ...
    confirmDelete() {
      ...
      this.confirmation = {
        confirmationMessage: 'Are you sure you would like to delete this class?'
      };
    },
      ...
      this.$store
        ...
        .then(() => {
          this.$snotify.success(
            "Selected class deleted successfully",
            {
              position: "rightTop",
